...
#ifndef MULE_CONCURRENT_UNORDERED_MAP_HPP
#define MULE_CONCURRENT_UNORDERED_MAP_HPP
...
public:
    ...
    UnorderedMap(UnorderedMap const& other) = delete;
    UnorderedMap& operator=(UnorderedMap const& other) = delete;
     ...
     *  @sa find(), end()
     */
    std::pair<iterator, bool> contains(Key const& key)
    {
        SharedLockType lock(m_mutex);
...
#endif // MULE_CONCURRENT_UNORDERED_MAP_HPP
